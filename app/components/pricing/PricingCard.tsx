  ...
  return (
    ...
    >
      <div
        ...
        aria-hidden
      />
      <div className="pointer-events-none absolute inset-0 rounded-[1.35rem] bg-gradient-to-br from-white/[0.07] via-transparent to-transparent opacity-80" aria-hidden />
