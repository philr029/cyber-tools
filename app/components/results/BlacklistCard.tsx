  ...
  return (
    ...
    >
      <div className="space-y-3">
        {/* Summary */}
        <div className="flex items-center gap-2 p-3 rounded-xl bg-slate-700/20 border border-[#162038]">
              ...
              <div className="flex items-center gap-2.5">
                <span
                  className={`flex-shrink-0 w-5 h-5 rounded-full flex items-center justify-center ${
                    entry.listed ? "bg-red-500/15" : "bg-emerald-500/15"
                  }`}
                >
                  {entry.listed ? (
                ...
                <div>
                  <p className="text-sm font-medium text-slate-300">{entry.source}</p>
