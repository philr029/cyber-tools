...
export interface MultiOutputBlock {
...
export interface MultiOutputToolProps {
  title: string;
  description: string;
  skill?: string;
  why?: string;
  futureApi?: string;
  fields: MultiOutputField[];
  /** Returns one or more named output blocks rendered with copy buttons. */
  generate: (values: Record<string, string>) => MultiOutputBlock[];
...
function initial(fields: MultiOutputField[]): Record<string, string> {
...
export default function MultiOutputTool(props: MultiOutputToolProps) {
