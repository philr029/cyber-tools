...
export const BANNERS: BannerConfig[] = [
  ...
  {
    id: "feature-automation-banner",
    version: 1,
    type: "success",
    icon: "*",
    title: "New automation tools added",
    message: "Explore the automation hub for planners, monitoring, and API smoke tests.",
    ctaText: "Open automation",
    ctaLink: "/automation-tools",
    dismissible: true,
    dismissTtlDays: 10,
    pathPrefixes: ["/"],
    auth: "any",
  ...
  {
    id: "api-integrations-roadmap",
    version: 1,
    type: "info",
    icon: "i",
    title: "API integrations coming soon",
    message: "Webhooks and CRM connectors are roadmap items — forms already support optional FORM_WEBHOOK_URL.",
    ctaText: "Forms centre",
    ctaLink: "/forms",
    dismissible: true,
    dismissTtlDays: 14,
  ...
  {
    id: "trial-upgrade-placeholder",
    version: 1,
    type: "warning",
    icon: "^",
    title: "Upgrade placeholders",
    message: "Pro and Business tiers describe future packaging — no checkout is enabled in this demo.",
    ctaText: "View pricing",
    ctaLink: "/pricing",
    dismissible: true,
    dismissTtlDays: 7,
    pathPrefixes: ["/pricing", "/tools/browse"],
    auth: "any",
  },
];
