...
export const MARKETING_TOOLS: MarketingToolDef[] = [
  ...
  t("seo-sitemap", "sitemap-checker", "Sitemap Checker", "Sanity-check sitemap URLs, duplicates and lastmod freshness.", "seo", "coming-soon", CS("sitemap-checker")),
  t("seo-robots", "robots-txt-checker", "Robots.txt Checker", "Interpret rules, disallows and crawl budget implications.", "seo", "coming-soon", CS("robots-txt-checker")),
  ...
  t("c-social", "social-post-generator", "Social Post Generator", "Multi-channel variants from one core message.", "content", "beta", CS("social-post-generator")),
